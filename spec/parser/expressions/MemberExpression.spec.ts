...
describe('Iterum::Parser::MemberExpression', () => {
  ...
  it('Should properly parse member expression with different combinations of accessors (1)', () => {
  ...
  it('Should properly parse member expression with different combinations of accessors (2)', () => {
    const source = 'foo.bar.baz.baa[1];';
    const ast = Parser.parse(source);
