...
describe("Iterum::SymbolTable", () => {
  it("Should properly define/lookup symbols in symbol table", () => {
    ...
    expect(table.define(new Symbol("foo", new StringValue("bar"))));
    expect(table.define(new Symbol("a", new NumberValue(42))));
  ...
  it("Should properly define/lookup symbols in enclosing scope", () => {
    ...
    expect(globalTable.define(new Symbol("foo", new StringValue("bar"))));
    expect(localTable.define(new Symbol("a", new NumberValue(42))));
